...
import com.example.whatsappia.activities.ContactsActivity
import com.example.whatsappia.listener.ContactsClickListener
import com.example.whatsappia.util.Contact
...
class ContactsAdapter(val contacts: ArrayList<Contact>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int)=
            ContactsViewHolder(LayoutInflater.from(parent.context).inflate(
